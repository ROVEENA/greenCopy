...
<body>
	<nav id="responsive-menu">
        <ul class="menu-holder">
            ...
            <li><a href="#about"><i class="fa fa-briefcase"></i>Adopt</a></li>
            <li><a href="#services"><i class="fa fa-cogs"></i>Rescue</a></li>
		...
		<div class="container">
			<div class="row templatemo-position-relative">				
				...
				<h1 class="templatemo-site-name">
                	<span class="templatemo-brown">ADORE &RESCUE</span> 
                	<span class="templatemo-gold">ADORESC</span>
                </h1>
			...
			<div class="row">
				...
				<div class="col-lg-6 col-md-6">
					<div class="templatemo-content-box templatemo-second-box">
						<h2 class="templatemo-brown">Hello, scroll down for more love</h2>
						<h3 class="templatemo-gold">
						<p class="margin-top-30"><span class="blue"></span><span class="green"></span></p>
						<a href="signup.php"text-uppercase templatemo-btn templatemo-info-btn">LET'S BEGIN</a>
					</div>					
				</div>
			</div>
		</div>
				...
				<div class="col-lg-6 col-md-6">
					<div class="templatemo-content-box text-right">
						<h2 class="templatemo-brown">
							<span class="templatemo-section-title">Know Our</span>
							<span class="templatemo-section-title"> <span class="templatemo-gold"><strong>Team AGENDA</strong></span></span>
						</h2>
						<p align="left" class="margin-top-30">A shelter pet is more than one in a million—she's one in 2.7 million. That's the number of adoptable dogs and cats who are still euthanized each year in the United States, simply because too many pets come into shelters and too few people adopt.

The number of euthanized animals could be reduced dramatically if more people adopted pets instead of buying them. When you adopt, you save your animal and open up shelter space for another animal who might need it.</p>
						<p align="left"></p>
								        ...
								        <li>
								        	<div class="text-center templatemo-team-member-container">
								        		<div class="templatemo-member-img-container">
								        			<class="templatemo-img-frame">
								        			<img src="images/team-member-1.jpg" alt="Team Member 1" class="tm-team-member-img">
								        		</div>								        		
												<h3 class="tm-team-member-title templatemo-gold text-uppercase margin-top-15"></h3>
												<img src="" alt="" class="margin-top-15 img-responsive center-block">
												<p class="margin-top-15"></p>
												<p class="templatemo-brown text-uppercase"></p>
											</div>
								        </li>
				...
				<div class="col-lg-6 col-md-6">
					<div class="templatemo-content-box text-right">
						<h2 class="templatemo-brown">
							...
							<span class="templatemo-section-title">Cared for<span class="templatemo-gold"><strong> Animals</strong></span></span>
						</h2>
							...
							<div class="jcarousel-wrapper templatemo-products">
								<div class="jcarousel">
								        	...
								        	<div class="templatemo-product-container text-center">
												<h3 class="templatemo-gold"></h3>
												<img src="images/product-11.jpg" alt="Product 1" class="templatemo-product-img">	
											</div>	
		...
		<div class="row">
			<div class="col-lg-12">
				<p class="templatemo-copyright-container text-uppercase small templatemo-brown">
					<span class="templatemo-copyright-text"> <a href="#" class="templatemo-gold></a></span>
					<!-- <span class="templatemo-copyright-design"><a href="http://www.templatemo.com" class="templatemo-gold"></a></span> 
				</p>
			</div>
		</div>		
	</footer>	
